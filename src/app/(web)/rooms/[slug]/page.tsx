...
const RoomDetails = (props: { params: { slug: string } }) => {
  ...
  const handleBookNowClick = async () => {
    if (!checkinDate || !checkoutDate)
      return toast.error('Por favor, infome a data do chekin e chekout');

    if (checkinDate > checkoutDate)
      return toast.error('Por favor, informe uma data válida para o chekout');
        ...
        <div className='md:grid md:grid-cols-12 gap-10 px-3'>
          <div className='md:col-span-8 md:w-full'>
            <div>
              ...
              <div className='mb-11'>
                <h2 className='font-bold text-3xl mb-2'>Oferecimento de comodidades</h2>
              ...
              <div className='mb-11'>
                <h2 className='font-bold text-3xl mb-2'>Saúde e Higiene</h2>
                <div className='grid grid-cols-2'>
                  ...
                  <div className='flex items-center my-1 md:my-0'>
                    ...
                    <p className='ml-2 md:text-base text-xs'>
                      Desinfectação e Esterilização
                    </p>
                  </div>
                  <div className='flex items-center my-1 md:my-0'>
                    <GiSmokeBomb />
                    <p className='ml-2 md:text-base text-xs'>Detectores de fumaçã</p>
                  </div>
                </div>
              </div>
              ...
              <div className='shadow dark:shadow-white rounded-lg p-6'>
                <div className='items-center mb-4'>
                  <p className='md:text-lg font-semibold'>Avaliação dos clientes</p>
                </div>
